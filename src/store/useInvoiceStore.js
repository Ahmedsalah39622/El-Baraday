...
export const useInvoiceStore = create((set, get) => ({
  ...
  fetchInvoices: async (limitOrBranch = 10000, branchIdArg = 'all', isSilent = false) => {
    let limit = 10000;
    let branchId = 'all';
  ...
  addInvoice: async (invoice) => {
    ...
    const newInvoice = {
      ...
      shiftId: invoice.shiftId || invoice.shift_id || null,
    ...
    try {
      ...
      if (res.ok) {
          ...
          invoices: state.invoices.map((inv) =>
            inv.id === newInvoice.id
              ? {
                  ...
                  shiftId: created.shift_id || inv.shiftId || null,
                  shift_id: created.shift_id || inv.shift_id || null,
        ...
        get().fetchInvoices(10000, targetBranch);
