...
export async function PUT(request, { params }) {
  try {
    ...
    const { status, driver_name, driver_id, dispatched_at, delivered_to_customer_at, is_cash_collected } = body;
    ...
    const updatedOrder = result.rows[0] || { ...currentOrder, status: targetStatus, is_cash_collected: Boolean(cashCollectedVal) };
